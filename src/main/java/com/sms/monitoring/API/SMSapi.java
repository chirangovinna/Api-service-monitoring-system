 ...
 */
public class SMSapi {
    String apiname = "SMS API ";
    private static final Logger logger = LoggerFactory.getLogger(SMSapi.class);
    private static final String API_URL = "https://e-sms.dialog.lk/api/v2/sms";
    ...
    public void send() throws URISyntaxException, IOException, InterruptedException {
        ...
        msisdnList.add("79999999");
        msisdnList.add("799999998");

        String pushNotificationUrl = "https://xxx/xx?";
        ...
        String payload = "{" +
                ...
                "{\"mobile\": \"" + msisdnList.get(1) + "\"}" +
                "]," +
                "\"push_notification_url\": \"" + pushNotificationUrl + "\"" +
                "}";
