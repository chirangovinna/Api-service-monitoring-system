...
public class ChargeCampaign {
    String apiname = "Charge Campaign API ";
    private static final Logger logger = LoggerFactory.getLogger(SMSapi.class);
    private static final String API_URL = "https://esms.dialog.lk/api/v1/charge";
    ...
    public void chargingForCampaign(int campaignId) throws URISyntaxException, IOException, InterruptedException {
